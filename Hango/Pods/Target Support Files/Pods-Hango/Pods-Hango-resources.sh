...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_resource "${PODS_CONFIGURATION_BUILD_DIR}/TZImagePickerController/TZImagePickerControllerPrivacy.bundle"
  install_resource "${PODS_ROOT}/TZImagePickerController/TZImagePickerController/Resources/TZImagePickerController.bundle"
