...
@interface HangoWebShellViewController () <WKNavigationDelegate, WKUIDelegate, WKScriptMessageHandler, UIGestureRecognizerDelegate>
...
@implementation HangoWebShellViewController
...
- (void)viewDidLoad {
    ...
    NSString *urlString = [[HangoLaunchManager shared] webEntryURLString];
...
- (void)handleCloseBridgeMessage {
    ...
    if (window) {
        [[HangoLaunchManager shared] enterWebQuickLoginInWindow:window animated:YES];
    }
}
