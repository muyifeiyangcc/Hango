...
- (void)setupUI {
    ...
    [_inviteesStack mas_makeConstraints:^(MASConstraintMaker *make) {
...
- (UIView *)labeledPickerFieldWithPrefix:(NSString *)prefix value:(NSString *)value compact:(BOOL)compact {
    ...
    [valueLabel mas_makeConstraints:^(MASConstraintMaker *make) {
        make.left.equalTo(prefixLabel.mas_right).offset(compact ? 2 : 4);
...
- (void)showPickerWithKind:(HangoPartyPickerKind)kind title:(NSString *)title {
    ...
    [cancelButton mas_makeConstraints:^(MASConstraintMaker *make) {
        ...
        make.bottom.equalTo(overlay.mas_safeAreaLayoutGuideBottom).offset(-20);
    }];
