...
- (void)setupUI {
    ...
    [_sheet mas_makeConstraints:^(MASConstraintMaker *make) {
        make.left.right.bottom.equalTo(self.view);
        make.height.mas_equalTo(300);
    }];
    [warningBox mas_makeConstraints:^(MASConstraintMaker *make) {
    ...
    [cancel mas_makeConstraints:^(MASConstraintMaker *make) {
        ...
        make.right.equalTo(_sheet.mas_centerX).offset(-8);
    }];
