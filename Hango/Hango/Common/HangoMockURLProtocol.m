...
static NSString * const kHangoMockHost = @"mock.hango.app";

@implementation HangoMockURLProtocol

+ (BOOL)canInitWithRequest:(NSURLRequest *)request {
    if ([NSURLProtocol propertyForKey:@"HangoMockHandled" inRequest:request]) {
        return NO;
    }
    return [request.URL.host isEqualToString:kHangoMockHost];
}
...
- (void)startLoading {
    ...
    [NSURLProtocol setProperty:@YES forKey:@"HangoMockHandled" inRequest:handledRequest];
