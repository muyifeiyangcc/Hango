...
typedef NS_ENUM(NSUInteger, HGXAxisType) {
    HGXAxisTypeHorizontal,
    HGXAxisTypeVertical
};

@interface NSArray (HGXAdditions)

/**
 *  Creates a HGXConstraintMaker with each view in the callee.
